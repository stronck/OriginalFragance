...
- PostgreSQL se puede crear desde Rollout con `rollout db add`; Rollout conecta la aplicación mediante `DATABASE_URL`.
...
En el plan gratuito Rollout ofrece una base PostgreSQL por aplicación, las aplicaciones pueden dormir cuando están inactivas y el servicio es de mejor esfuerzo, sin garantía de disponibilidad.
