...
('PACO RABANNE c- 1 FAME 80ml', 'Un perfume femenino con notas de menta, sangre de dragón y ámbar, ideal para ocasiones nocturnas. Duración de 12 a 24 horas. Envase dorado con detalle de medallón. <s><s>$649.999</s></s>', 599900.00),
('PACO RABANNE c- 1 PURE XS BLACK 100ml', 'Un perfume masculino que combina notas de café y vainilla intensa, ofreciendo un aroma sensual con un toque de misterio y seducción. <s><s>$639.999</s></s>', 619900.00),
('PACO RABANNE c- 1 LADY MILLION 80ml', 'Un perfume femenino, fresco, floral y seductor que combina neroli, jazmín, patchouli y especias, brindando un toque de glamour y sofisticación. <s><s>$529.999</s></s>', 499900.00),
('PACO RABANNE c- 1 PURE XS 100ml', 'Un perfume masculino acuático y fresco que mezcla notas de pomelo, mandarina y flor de naranjo, aportando dinamismo y aventura. <s><s>$649.999</s></s>', 599900.00);
