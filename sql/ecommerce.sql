...
('PACO RABANNE c- 1 PURE XS BLACK 100ml', 'Un perfume masculino que combina notas de café y vainilla intensa, ofreciendo un aroma sensual con un toque de misterio y seducción. <s>$639.999</s>', 619900.00),
...
('PACO RABANNE c- 1 PURE XS 100ml', 'Un perfume masculino acuático y fresco que mezcla notas de pomelo, mandarina y flor de naranjo, aportando dinamismo y aventura. <s>$649.999</s>', 599900.00);
